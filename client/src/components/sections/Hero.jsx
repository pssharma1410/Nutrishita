...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-surface pb-16 pt-28 md:pb-24 md:pt-36">
      ...
      <FadeUp
        stagger
        className="relative mx-auto grid max-w-6xl items-center gap-12 px-6 lg:grid-cols-[minmax(0,3fr)_minmax(0,2fr)] lg:gap-16"
      >
        <div className="fade-up flex flex-col">
          <p className="eyebrow mb-4">Evidence-Based Nutrition Consulting</p>
          <h1 className="hero-title max-w-2xl text-[40px] leading-[1.1] md:text-[64px] md:leading-[72px]">
          ...
          <div className="mt-10 flex flex-wrap items-center gap-4">
            <button
              ...
              className="inline-flex items-center justify-center rounded-full bg-sage-mid px-8 py-3.5 text-base font-semibold text-white shadow-md transition duration-200 hover:bg-sage-600 hover:shadow-lg"
            >
            ...
            <button
              ...
              className="group inline-flex items-center gap-2 rounded-full border border-border bg-white/80 px-6 py-3.5 text-base font-semibold text-sage-800 shadow-sm transition duration-200 hover:border-sage-mid/40 hover:bg-white"
            >
              Learn more
        ...
        <div className="fade-up relative mx-auto w-full max-w-md lg:mx-0 lg:max-w-none" aria-hidden>
          <div className="relative flex justify-center lg:justify-end">
            ...
            <div className="animate-hero-float absolute bottom-6 left-1/2 w-[min(100%,280px)] -translate-x-1/2 rounded-2xl bg-white p-5 shadow-xl md:bottom-10 md:w-[260px]">
